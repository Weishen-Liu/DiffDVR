...
def compute(settings_file, name, smoothness_prior,
    ...
    def load_image_as_input(image_folder_full_path):
        ...
        for i in range(NumViews):
            ...
            single_image = torch.transpose(single_image, 0, 2)
            single_image = torch.transpose(single_image, 0, 1)
    ...
    def renderReference():
        ...
        if EXTRACT_IMAGE_FROM_DIFFDVR_RENDERER:
            try:
                a = 1/0
                load_images = torch.load("/mnt/scratch/ssd/weishen/DiffDVR/pytests/tests/image.t")
                images = load_images
            except:
                torch.save(images, "/mnt/scratch/ssd/weishen/DiffDVR/pytests/tests/image.t")
                for i, x in enumerate(images):
                    x = torch.transpose(x, 0, 2)
                    x = torch.transpose(x, 1, 2)
                    print(x.shape)
                    save_image(x, '/mnt/scratch/ssd/weishen/DiffDVR/pytests/tests/from_diffdvr_mechanic_hand_img/img' + str(i) + ".png")
        ...
        full_results['reference'] = {
            'tf': tf.detach().cpu().numpy(),
            'images': reference_images.detach().cpu().numpy()
        }
...
def visualize_smoothingPriors(settings_file, name):
    ...
    json_output_folder = get_result_folder("tf/image_" + name + "/comparison/json")
    ...
    for i,pstr in enumerate(smoothness_priors):
        ...
        tf_to_texture(local_tf, os.path.join(json_output_folder, "tf-prior%s-final.json" % pstr), out_format='txt')
        ...
        if reference_tf is None:
            ...
            tf_to_texture(reference_tf, os.path.join(json_output_folder, "reference-tf.json"), out_format='txt')
...
if __name__ == '__main__':
    ...
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.500, iterations, optimizer, False)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 1.000, iterations, optimizer, False)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 2.000, iterations, optimizer, False)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 3.000, iterations, optimizer, False)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 4.000, iterations, optimizer, False)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 5.000, iterations, optimizer, False)
    visualize_smoothingPriors("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand")

    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.000, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.010, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.020, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.030, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.040, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.050, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.100, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.200, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.300, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.400, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.500, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 1.000, iterations, optimizer, all_renderer=False)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 2.000, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 3.000, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 4.000, iterations, optimizer, all_renderer=False, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 5.000, iterations, optimizer, all_renderer=False, Min_R=2)
    # visualize_smoothingPriors("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand")

    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.000, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.010, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.020, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.030, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.040, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.050, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.100, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.200, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.300, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.400, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 0.500, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 1.000, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 2.000, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 3.000, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 4.000, iterations, optimizer, all_renderer=True, Min_R=2)
    # compute("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand", 5.000, iterations, optimizer, all_renderer=True, Min_R=2)
    # visualize_smoothingPriors("config-files/ovr_mechanic_hand.json", "DiffRenderMechanicHand")
